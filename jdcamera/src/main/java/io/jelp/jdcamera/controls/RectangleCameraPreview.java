...
public class RectangleCameraPreview extends SurfaceView {

    public static final String TAG = RectangleCameraPreview.class.getSimpleName();
    ...
    public RectangleCameraPreview(Context context) {
        super(context);
        init(context);
    }

    public RectangleCameraPreview(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public RectangleCameraPreview(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    private void init(Context context) {
        mScaleDetector = new ScaleGestureDetector(context, new RectangleCameraPreview.ScaleListener());
