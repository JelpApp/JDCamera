...
public class SquareSavePhotoFragment extends Fragment{
    public static final String TAG = SquareSavePhotoFragment.class.getSimpleName();
    ...
    public static Fragment newInstance(byte[] bitmapByteArray, int rotation,
        ...
        Fragment fragment = new SquareSavePhotoFragment();
    ...
    public SquareSavePhotoFragment() {}

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_square_save_photo, container, false);
    }
...
//        Log.d(TAG, "original bitmap width " + bitmap.getWidth() + " height " + bitmap.getHeight());
    ...
    private void requestForPermission() {
        RuntimePermissionActivity.startActivity(SquareSavePhotoFragment.this,
                REQUEST_STORAGE,
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (REQUEST_STORAGE == requestCode && data != null) {
            ...
            if (isGranted && view != null) {
                ...
                Uri photoUri = ImageUtility.savePicture(getActivity(), bitmap,true,getArguments());
