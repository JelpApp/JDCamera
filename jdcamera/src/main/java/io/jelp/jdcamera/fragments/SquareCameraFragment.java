...
import io.jelp.jdcamera.controls.SquareCameraPreview;
...
public class SquareCameraFragment extends Fragment implements SurfaceHolder.Callback, Camera.PictureCallback, ImagesAdapter.OnItemClickListener{
    public static final String TAG = SquareCameraFragment.class.getSimpleName();
    ...
    public static Fragment newInstance(Bundle bundle) {
        SquareCameraFragment fragment = new SquareCameraFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_square_camera, container, false);
    }
...
//        Log.d(TAG, "Rotate Picture by: " + rotation);
        getFragmentManager()
                ...
                .replace(
                        ...
                        SquareSavePhotoFragment.newInstance(data, rotation, mImageParameters.createCopy()),
