...
import io.jelp.jdcamera.RuntimePermissionActivity;
import io.jelp.jdcamera.tools.ImageParameters;
import io.jelp.jdcamera.tools.ImageUtility;

public class RectangleSavePhotoFragment extends Fragment {
    public static final String TAG = RectangleSavePhotoFragment.class.getSimpleName();
    ...
    public static Fragment newInstance(byte[] bitmapByteArray, int rotation,
                                       @NonNull ImageParameters parameters,Bundle args) {
        Fragment fragment = new RectangleSavePhotoFragment();
    ...
    public RectangleSavePhotoFragment() {}

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_rectangle_save_photo, container, false);
    }
...
//        Log.d(TAG, "original bitmap width " + bitmap.getWidth() + " height " + bitmap.getHeight());
    ...
    private void requestForPermission() {
        RuntimePermissionActivity.startActivity(RectangleSavePhotoFragment.this,
                REQUEST_STORAGE,
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (REQUEST_STORAGE == requestCode && data != null) {
            ...
            if (isGranted && view != null) {
                ...
                Uri photoUri = ImageUtility.savePicture(getActivity(), bitmap,false,getArguments());
